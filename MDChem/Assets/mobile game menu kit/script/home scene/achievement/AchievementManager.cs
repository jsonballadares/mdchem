...
public class AchievementManager : MonoBehaviour {
    ...
    public void UnlockAchievement(int id)
    {
        ...
        //reward
        my_game_master.stars_total_score[my_game_master.current_profile_selected] += achievements[id].starRevard;
        PlayerPrefs.SetInt("profile_" + my_game_master.current_profile_selected.ToString() + "_total_stars", my_game_master.stars_total_score[my_game_master.current_profile_selected]);
        my_game_master.current_virtual_money[my_game_master.current_profile_selected] += achievements[id].virtualMoneyReward;
