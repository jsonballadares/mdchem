...
public class manage_menu_uGUI : MonoBehaviour
{
    ...
    /*[HideInInspector]*/
    public TextMeshProUGUI no_lives_left_countdown;
    ...
    /*[HideInInspector]*/
    public TextMeshProUGUI current_profile_name;
    ...
    {
        if (my_game_master.profile_name[my_game_master.current_profile_selected] != "")
            current_profile_name.text = "Welcome   " + my_game_master.profile_name[my_game_master.current_profile_selected] + "  !";
        else
    ...
    {
        my_game_master.current_world[my_game_master.current_profile_selected] = this_world_n;
    ...
    public void Update_page_dot(int current_page)
    {
        ...
        for (int i = 0; i < pages[my_game_master.current_world[my_game_master.current_profile_selected]]; i++)
        {
    ...
    void Start_to_play()
    {
        ...
        else if (my_game_master.press_start_and_go_to_selected == game_master.press_start_and_go_to.map)
        {
            Mark_current_screen(map_screen);
            Mark_this_button(stage_screen_target_button);
            map_screen.GetComponent<manage_linear_map>().Center_to_this_icon(my_game_master.play_this_stage_to_progress_in_the_game_world[my_game_master.current_profile_selected], my_game_master.play_this_stage_to_progress_in_the_game_stage[my_game_master.current_profile_selected]);
        }
        else if (my_game_master.press_start_and_go_to_selected == game_master.press_start_and_go_to.single_screen_with_a_page_for_every_world)
        {
            Mark_current_screen(multi_page_screen);
        ...
        else if (my_game_master.press_start_and_go_to_selected == game_master.press_start_and_go_to.straight_to_the_next_game_stage)
        {
            ...
            SceneManager.LoadScene("W" + (my_game_master.play_this_stage_to_progress_in_the_game_world[my_game_master.current_profile_selected] + 1).ToString() + "_Stage_" + (my_game_master.play_this_stage_to_progress_in_the_game_stage[my_game_master.current_profile_selected] + 1).ToString());
        }
    }
    ...
    public void Go_to_store_screen(int store_tab)
    {
        ...
        stages_screen_manual[my_game_master.current_world[my_game_master.current_profile_selected]].gameObject.SetActive(false);
        worlds_screen_manual.gameObject.SetActive(false);
            ...
            if (my_game_master.press_start_and_go_to_selected == game_master.press_start_and_go_to.nested_world_stage_select_screen)
            {
                ...
                if (my_game_master.total_stages_in_world_n.Length > 1)
                {
                    ...
                    else if (my_game_master.stage_screen_generation_selected == game_master.stage_screen_generation.manual)
                    {
                        ...
                        if (current_screen == stages_screen_manual[my_game_master.current_world[my_game_master.current_profile_selected]])
                            Go_to_world_screen(true);
                        else
                        {
                            Mark_current_screen(home_screen);
    ...
    void Stage_icon_animation_aborted()
    {
        ...
        my_game_master.dot_tail_turn_on[my_game_master.current_profile_selected][my_game_master.play_this_stage_to_progress_in_the_game_world[my_game_master.current_profile_selected], my_game_master.play_this_stage_to_progress_in_the_game_stage[my_game_master.current_profile_selected]] = true;
        Update_profile_name(true);
    }
    ...
    void Go_to_world_screen(bool from_stage_screen)
    {
        if (my_game_master.world_screen_generation_selected == game_master.world_screen_generation.automatic)
        {
            ...
            if (from_stage_screen)
                Mark_this_button(world_container.GetChild(my_game_master.current_world[my_game_master.current_profile_selected]).gameObject);//mark current world
            else
